...
@Composable fun SettingsScreen(state: UiState, folders: Set<String>, add: () -> Unit, scan: () -> Unit, remove: (String) -> Unit, downloadMaest: () -> Unit, removeMaest: () -> Unit, analyzeLibrary: () -> Unit, cancelAnalysis: () -> Unit, setParallelism: (Int) -> Unit, exportBackup: () -> Unit, importBackup: () -> Unit) { Column(Modifier.fillMaxSize()) { Header("Impostazioni", "Cartelle, catalogazione e AI locale"); LazyColumn(contentPadding = PaddingValues(horizontal = 16.dp, vertical = 0.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
